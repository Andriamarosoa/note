"""Run corrected V17.7 while tolerating only the inherited stale V13 print key."""
from __future__ import annotations

import json

from scripts import train_v130_causal_event_set_decoder as v130
from scripts import train_v177_candidate_centric_feasible as v177f
...
def main(argv=None):
    args = v177f.parser().parse_args(argv)
    v130.train_fold = _v130_train_fold_compat
    try:
        return v177f.train_fold(args)
    finally:
